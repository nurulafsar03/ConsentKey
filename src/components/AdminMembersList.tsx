    ...
    <div className={`rounded-3xl p-5 shadow-sm space-y-4 border transition ${
      ...
      <div className="space-y-2.5 max-h-[380px] overflow-y-auto pr-1">
        {filteredMembers.length === 0 ? (
          <div className="text-center py-8 px-4 rounded-2xl border border-dashed border-slate-300 dark:border-slate-800 space-y-3">
            ...
            <div className="text-xs font-semibold text-slate-700 dark:text-slate-300">
              {members.length === 0 ? 'No members in this circle yet' : t.noMembersMatch}
            </div>
            <p className="text-[11px] text-slate-500 max-w-xs mx-auto">
              Share your circle invite code or add members to see real-time consent-based GPS tracking on your map.
            </p>
